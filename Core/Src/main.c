...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LORA_NSS_Pin|LORA_RST_Pin|LD2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LORA_NSS_Pin LORA_RST_Pin LD2_Pin */
  GPIO_InitStruct.Pin = LORA_NSS_Pin|LORA_RST_Pin|LD2_Pin;
